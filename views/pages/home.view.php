...
<section>
    <div class="form-group">
        <h2 class="type_title">Sản phẩm Nữ</h2>
        <div class="row">
            <?php foreach ($femaleProducts as $femaleProduct):?>

                <div class="col-md-3">
                    <div class="box">
                        <a href="<?=route("pages", "showProduct&id=" . $femaleProduct->id)?>"><img src="uploads/<?=$femaleProduct->image?>"></a>
                        <p><a href="<?=route("pages", "showProduct&id=" . $femaleProduct->id)?>"><?=$femaleProduct->name?></a></p>
                        <p>Giá : <span class="price"><?=$femaleProduct->price?>đ</span></p>
                        <a class="btn btn-primary" href="<?=route("orders", "insertShoppingCartItem&id=" . $femaleProduct->id)?>"> <span class="glyphicon glyphicon-shopping-cart"></span> Thêm vào giỏ hàng</a>
                    </div>
                </div>
